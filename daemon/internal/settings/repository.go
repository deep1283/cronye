...
const (
	...
	KeyCatchupLastRunAt        = "catchup_last_run_at"
	KeyCatchupWindowStartAt    = "catchup_window_start_at"
	KeyCatchupWindowEndAt      = "catchup_window_end_at"
	KeyCatchupJobsScanned      = "catchup_jobs_scanned"
	KeyCatchupRunsEnqueued     = "catchup_runs_enqueued"
	KeyCatchupSkippedExisting  = "catchup_skipped_existing"
	KeyCatchupTruncatedJobs    = "catchup_truncated_jobs"
